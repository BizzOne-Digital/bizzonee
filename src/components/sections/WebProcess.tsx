    ...
    <section className="relative py-20 sm:py-28">
      ...
      <div className="section">
            ...
            return (
              <div key={step.n}>
                <div className="absolute z-10" style={{ left: x, top: y, transform: "translate(-50%, -50%)" }}>
                  <motion.div initial={{ scale: 0.4, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 220, damping: 16, delay: i * 0.16 }}>
                ...
                <div className="absolute z-10 w-44 text-center" style={{ left: x, top: up ? y + OFFSET : y - OFFSET, transform: up ? "translateX(-50%)" : "translate(-50%, -100%)" }}>
                  <motion.div initial={{ opacity: 0, y: up ? 12 : -12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.16 + 0.15 }}>
        ...
        <div className="relative mt-12 pl-20 lg:hidden">
          ...
          {STEPS.map((step, i) => (
            <motion.div key={step.n} initial={{ opacity: 0, x: 16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5, delay: i * 0.08 }} className="relative mb-9 last:mb-0">
