...
import { MessageSquare, PenTool, Code2, TestTube2, Rocket, type LucideIcon } from "lucide-react";
...
const STEPS: Step[] = [
  { n: "01", title: "Discovery Call", description: "We map out your app's goals, features and target platforms together.", icon: MessageSquare },
  { n: "02", title: "UI/UX Design", description: "Wireframes and clickable prototypes so you see the app before we build it.", icon: PenTool },
  { n: "03", title: "Development", description: "Our team builds your app with clean, scalable, production-ready code.", icon: Code2 },
  { n: "04", title: "Testing & QA", description: "Rigorous device and platform testing to catch issues before launch.", icon: TestTube2 },
  { n: "05", title: "Launch & Support", description: "We submit to the App Store / Play Store and support you after launch.", icon: Rocket },
];
      ...
      <div className="section">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/90">
            Five proven steps that take your app from idea to the App Store, on time and on budget.
          </p>
        </Reveal>
        ...
        <div ref={ref} className="relative mx-auto mt-10 hidden max-w-6xl lg:block" style={{ height: H }}>
          <svg className="absolute inset-0" width="100%" height={H} viewBox={`0 0 ${w} ${H}`} preserveAspectRatio="none" fill="none">
            <defs>
              <marker id="ap-arrow" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
